CREATE OR REPLACE PACKAGE  stpks_stdbea1_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdbea1_main.spc
  **
...
TYPE ty_stdbea1 IS RECORD (
     v_stb_master_sc1     stb_master_sc1%ROWTYPE,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdbea1_main FOR stpks_stdbea1_main
/