CREATE OR REPLACE PACKAGE  stpks_stdbsc3_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdbsc3_main.spc
  **
...
TYPE ty_tb_v_sttm_detail_sbs3 IS TABLE OF sttm_detail_sbs3%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_stdbsc3 IS RECORD (
     v_sttm_master_sbs3     sttm_master_sbs3%ROWTYPE,
     v_sttm_detail_sbs3    ty_tb_v_sttm_detail_sbs3,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdbsc3_main FOR stpks_stdbsc3_main
/