CREATE OR REPLACE PACKAGE  stpks_stdbsc3_custom AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdbsc3_custom.spc
  **
...
/
CREATE OR REPLACE SYNONYM stpkss_stdbsc3_custom FOR stpks_stdbsc3_custom
/