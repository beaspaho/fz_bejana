CREATE OR REPLACE PACKAGE  stpks_stdbsu4_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdbsu4_main.spc
  **
...
TYPE ty_tb_v_sttm_detail_susht42 IS TABLE OF sttm_detail_susht42%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_stdbsu4 IS RECORD (
     v_sttm_master_susht42     sttm_master_susht42%ROWTYPE,
     v_sttm_detail_susht42    ty_tb_v_sttm_detail_susht42,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdbsu4_main FOR stpks_stdbsu4_main
/