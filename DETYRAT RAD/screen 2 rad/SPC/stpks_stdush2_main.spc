CREATE OR REPLACE PACKAGE  stpks_stdush2_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdush2_main.spc
  **
...
TYPE ty_tb_v_sttm_detail_susht3 IS TABLE OF sttm_detail_susht3%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_stdush2 IS RECORD (
     v_sttm_detail_susht3    ty_tb_v_sttm_detail_susht3,
     v_sttm_master_susht2     sttm_master_susht2%ROWTYPE,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdush2_main FOR stpks_stdush2_main
/