CREATE OR REPLACE PACKAGE  stpks_stdush3_custom AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdush3_custom.spc
  **
...
/
CREATE OR REPLACE SYNONYM stpkss_stdush3_custom FOR stpks_stdush3_custom
/