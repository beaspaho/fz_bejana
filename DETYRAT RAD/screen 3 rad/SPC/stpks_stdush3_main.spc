CREATE OR REPLACE PACKAGE  stpks_stdush3_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdush3_main.spc
  **
...
TYPE ty_tb_v_sttm_detail_sus3 IS TABLE OF sttm_detail_sus3%ROWTYPE INDEX BY BINARY_INTEGER;

TYPE ty_stdush3 IS RECORD (
     v_sttm_master_sus3     sttm_master_sus3%ROWTYPE,
     v_sttm_detail_sus3    ty_tb_v_sttm_detail_sus3,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdush3_main FOR stpks_stdush3_main
/