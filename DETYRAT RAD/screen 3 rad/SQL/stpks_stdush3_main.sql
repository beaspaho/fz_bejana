CREATE OR REPLACE PACKAGE BODY stpks_stdush3_main AS
     /*-----------------------------------------------------------------------------------------------------
     **
     ** File Name  : stpks_stdush3_main.sql
     **
   ...
   g_Ui_Name            VARCHAR2(50) := 'STDUSH3';
   g_stdush3         stpks_stdush3_Main.ty_stdush3;
   ...
   BEGIN
      stpks_stdush3_Custom.Pr_Skip_Handler (P_Stage);
   END Pr_Skip_Handler;
   ...
   BEGIN
      ...
      LOOP
         ...
         IF  l_Node = 'BLK_MASTER' THEN
            p_stdush3.v_sttm_master_sus3.CUST_CAT := Cspks_Req_Global.Fn_GetVal;
            p_stdush3.v_sttm_master_sus3.CUST_ID := Cspks_Req_Global.Fn_GetVal;
            p_stdush3.v_sttm_master_sus3.CUST_TYPE := Cspks_Req_Global.Fn_GetVal;
            p_stdush3.v_sttm_master_sus3.MAKER_ID := Cspks_Req_Global.Fn_GetVal;
            l_Val       := Cspks_Req_Global.Fn_GetVal;
            IF Length(l_Val) > Length(Cspks_Req_Global.g_Date_Format) THEN
               p_stdush3.v_sttm_master_sus3.MAKER_DT_STAMP := TO_DATE(l_val,Cspks_Req_Global.g_Date_Time_Format);
            ELSE
               p_stdush3.v_sttm_master_sus3.MAKER_DT_STAMP := TO_DATE(l_val,Cspks_Req_Global.g_Date_Format);
            END IF;
            p_stdush3.v_sttm_master_sus3.CHECKER_ID := Cspks_Req_Global.Fn_GetVal;
            l_Val       := Cspks_Req_Global.Fn_GetVal;
            IF Length(l_Val) > Length(Cspks_Req_Global.g_Date_Format) THEN
               p_stdush3.v_sttm_master_sus3.CHECKER_DT_STAMP := TO_DATE(l_val,Cspks_Req_Global.g_Date_Time_Format);
            ELSE
               p_stdush3.v_sttm_master_sus3.CHECKER_DT_STAMP := TO_DATE(l_val,Cspks_Req_Global.g_Date_Format);
            END IF;
            p_stdush3.v_sttm_master_sus3.MOD_NO := Cspks_Req_Global.Fn_GetVal;
            p_stdush3.v_sttm_master_sus3.RECORD_STAT := Cspks_Req_Global.Fn_GetVal;
            p_stdush3.v_sttm_master_sus3.AUTH_STAT := Cspks_Req_Global.Fn_GetVal;
            p_stdush3.v_sttm_master_sus3.ONCE_AUTH := Cspks_Req_Global.Fn_GetVal;
         ELSIF  l_Node = 'BLK_DETAIL' THEN
            l_Dsn_Rec_Cnt_2 :=  p_stdush3.v_sttm_detail_sus3.count +1 ;
            p_stdush3.v_sttm_detail_sus3(l_Dsn_Rec_Cnt_2).CUST_ID_DET := Cspks_Req_Global.Fn_GetVal;
            p_stdush3.v_sttm_detail_sus3(l_Dsn_Rec_Cnt_2).FIELD_DES := Cspks_Req_Global.Fn_GetVal;
            p_stdush3.v_sttm_detail_sus3(l_Dsn_Rec_Cnt_2).MANDATORY_VALIDATION := Cspks_Req_Global.Fn_GetVal;
            p_stdush3.v_sttm_detail_sus3(l_Dsn_Rec_Cnt_2).TEMP := Cspks_Req_Global.Fn_GetVal;
            p_stdush3.v_sttm_detail_sus3(l_Dsn_Rec_Cnt_2).cust_id_det :=p_stdush3.v_sttm_master_sus3.cust_id;
         END IF;
         l_Node := Cspks_Req_Global.Fn_GetNode;
      END LOOP;

      p_stdush3.Addl_Info := p_Addl_Info;
      Dbg('Returning Success From Fn_Sys_Build_Fc_Type.. ');
      RETURN TRUE;

   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdush3_Main.Fn_Sys_Build_Fc_Type ');
         ...
         IF  l_Node IN ( 'BLK_MASTER','Master-Full','Master-IO') THEN
            ...
            LOOP
               ...
               IF l_Key = 'CUST_CAT' THEN
                  p_stdush3.v_sttm_master_sus3.CUST_CAT := l_Val;
               ELSIF l_Key = 'CUST_ID' THEN
                  p_stdush3.v_sttm_master_sus3.CUST_ID := l_Val;
               ELSIF l_Key = 'CUST_TYPE' THEN
                  p_stdush3.v_sttm_master_sus3.CUST_TYPE := l_Val;
               ELSIF l_Key = 'MAKER' THEN
                  p_stdush3.v_sttm_master_sus3.MAKER_ID := l_Val;
               ...
               ELSIF l_Key = 'CHECKER' THEN
                  p_stdush3.v_sttm_master_sus3.CHECKER_ID := l_Val;
               ...
               ELSIF l_Key = 'MODNO' THEN
                  p_stdush3.v_sttm_master_sus3.MOD_NO := l_Val;
               ELSIF l_Key = 'TXNSTAT' THEN
                  p_stdush3.v_sttm_master_sus3.RECORD_STAT := l_Val;
               ELSIF l_Key = 'AUTHSTAT' THEN
                  p_stdush3.v_sttm_master_sus3.AUTH_STAT := l_Val;
               ELSIF l_Key = 'ONCEAUTH' THEN
                  p_stdush3.v_sttm_master_sus3.ONCE_AUTH := l_Val;
               END IF;
               l_Key       := Cspks_Req_Global.Fn_GetTag;
               l_Val       := Cspks_Req_Global.Fn_GetVal;
            END LOOP;
         ELSIF  l_Node IN ( 'BLK_DETAIL','Detail') THEN
            ...
            LOOP
               ...
               IF l_Key = 'CUST_ID_DET' THEN
                  p_stdush3.v_sttm_detail_sus3(l_Dsn_Rec_Cnt_2).CUST_ID_DET := l_Val;
               ELSIF l_Key = 'FIELD_DES' THEN
                  p_stdush3.v_sttm_detail_sus3(l_Dsn_Rec_Cnt_2).FIELD_DES := l_Val;
               ELSIF l_Key = 'MANDATORY_VALIDATION' THEN
                  p_stdush3.v_sttm_detail_sus3(l_Dsn_Rec_Cnt_2).MANDATORY_VALIDATION := l_Val;
               ELSIF l_Key = 'TEMP' THEN
                  p_stdush3.v_sttm_detail_sus3(l_Dsn_Rec_Cnt_2).TEMP := l_Val;
               END IF;
               l_Key       := Cspks_Req_Global.Fn_GetTag;
               l_Val       := Cspks_Req_Global.Fn_GetVal;
            END LOOP;
   ...
   BEGIN
      ...
      Cspks_Req_Global.Pr_Write('V','CUST_CAT',p_stdush3.v_sttm_master_sus3.cust_cat);
      Cspks_Req_Global.Pr_Write('V','CUST_ID',p_stdush3.v_sttm_master_sus3.cust_id);
      Cspks_Req_Global.Pr_Write('V','CUST_TYPE',p_stdush3.v_sttm_master_sus3.cust_type);
      Cspks_Req_Global.Pr_Write('V','MAKER',p_stdush3.v_sttm_master_sus3.maker_id);
      IF trunc(p_stdush3.v_sttm_master_sus3.maker_dt_stamp) <>
            p_stdush3.v_sttm_master_sus3.maker_dt_stamp THEN
         l_Date_Val :=  TO_CHAR( p_stdush3.v_sttm_master_sus3.maker_dt_stamp,Cspks_Req_Global.g_Ws_Date_Time_Format);
      ELSE
         l_Date_Val :=  TO_CHAR( p_stdush3.v_sttm_master_sus3.maker_dt_stamp,Cspks_Req_Global.g_Ws_Date_Format);
      END IF;
      Cspks_Req_Global.Pr_Write('V','MAKERSTAMP',l_Date_Val);
      Cspks_Req_Global.Pr_Write('V','CHECKER',p_stdush3.v_sttm_master_sus3.checker_id);
      IF trunc(p_stdush3.v_sttm_master_sus3.checker_dt_stamp) <>
            p_stdush3.v_sttm_master_sus3.checker_dt_stamp THEN
         l_Date_Val :=  TO_CHAR( p_stdush3.v_sttm_master_sus3.checker_dt_stamp,Cspks_Req_Global.g_Ws_Date_Time_Format);
      ELSE
         l_Date_Val :=  TO_CHAR( p_stdush3.v_sttm_master_sus3.checker_dt_stamp,Cspks_Req_Global.g_Ws_Date_Format);
      END IF;
      Cspks_Req_Global.Pr_Write('V','CHECKERSTAMP',l_Date_Val);
      Cspks_Req_Global.Pr_Write('V','MODNO',p_stdush3.v_sttm_master_sus3.mod_no);
      Cspks_Req_Global.Pr_Write('V','TXNSTAT',p_stdush3.v_sttm_master_sus3.record_stat);
      Cspks_Req_Global.Pr_Write('V','AUTHSTAT',p_stdush3.v_sttm_master_sus3.auth_stat);
      Cspks_Req_Global.Pr_Write('V','ONCEAUTH',p_stdush3.v_sttm_master_sus3.once_auth);

      --Dbg('Building Childs Of :BLK_MASTER..');
      l_Dsn_Rec_Cnt_2 := 0;
      IF p_stdush3.v_sttm_detail_sus3.COUNT > 0 THEN
         FOR i_2 IN  1..p_stdush3.v_sttm_detail_sus3.COUNT LOOP
            l_Dsn_Rec_Cnt_2 := i_2;
            ...
            Cspks_Req_Global.Pr_Write('V','CUST_ID_DET',p_stdush3.v_sttm_detail_sus3(l_Dsn_Rec_Cnt_2).cust_id_det);
            Cspks_Req_Global.Pr_Write('V','FIELD_DES',p_stdush3.v_sttm_detail_sus3(l_Dsn_Rec_Cnt_2).field_des);
            Cspks_Req_Global.Pr_Write('V','MANDATORY_VALIDATION',p_stdush3.v_sttm_detail_sus3(l_Dsn_Rec_Cnt_2).mandatory_validation);
            Cspks_Req_Global.Pr_Write('V','TEMP',p_stdush3.v_sttm_detail_sus3(l_Dsn_Rec_Cnt_2).temp);
         END LOOP;
      END IF;
   ...
   BEGIN
      ...
      IF SUBSTR(p_Exchange_Pattern,3,4) = 'FS' THEN
         ...
         --Dbg('Building Childs Of :..');
         IF (  p_stdush3.v_sttm_master_sus3.cust_id IS NOT NULL 
          )
          THEN
            l_1_Lvl_Counter := 0;
            l_0_Lvl_Counter   := l_0_Lvl_Counter +1;
      ...
      ELSE
         ...
         l_Key_Cols := 'CUST_ID~';
         l_Key_Vals := p_stdush3.v_sttm_master_sus3.cust_id||'~';
   ...
   BEGIN
      ...
      l_Fld := 'STTM_MASTER_SUS3.CUST_ID';
      IF p_stdush3.v_sttm_master_sus3.cust_id IS Null THEN
      ...
      IF p_Pk_Or_Full = 'FULL'  THEN
         ...
         l_Blk := 'STTM_MASTER_SUS3';
         l_Fld := 'STTM_MASTER_SUS3.CUST_TYPE';
         IF p_stdush3.v_sttm_master_sus3.cust_type IS Null THEN
            Dbg('Mandatory Key Column cust_type Cannot Be Null');
            Pr_Log_Error(p_Source,'ST-MAND-004','@'||l_Fld );
         END IF;

         l_Blk := 'STTM_DETAIL_SUS3';
         l_Count := p_stdush3.v_sttm_detail_sus3.COUNT;
         IF l_Count > 0 THEN
            FOR l_index IN 1 .. p_stdush3.v_sttm_detail_sus3.COUNT LOOP
               l_Fld := 'STTM_DETAIL_SUS3.TEMP';
               IF p_stdush3.v_sttm_detail_sus3(l_Index).temp IS Null THEN
                  Dbg('Primary Key Column temp Cannot Be Null');
                  l_Key := Null;
   ...
   BEGIN
      ...
      IF p_stdush3.v_sttm_master_sus3.CUST_TYPE IS NOT NULL THEN
         IF p_stdush3.v_sttm_master_sus3.CUST_TYPE NOT IN ('Individual','Partnership','Coorporate ','Resident') THEN
            dbg('Invalid Value For The Field  :CUST_TYPE:'||p_stdush3.v_sttm_master_sus3.CUST_TYPE);
            Pr_Log_Error(p_Source,'ST-VALS-011',p_stdush3.v_sttm_master_sus3.CUST_TYPE||'~@STTM_MASTER_SUS3.CUST_TYPE~@STTM_MASTER_SUS3') ;
         END IF;
      END IF;
      l_Count      := p_stdush3.v_sttm_detail_sus3.COUNT;
      IF l_Count > 0 THEN
         FOR l_index  IN 1 .. l_Count LOOP
            l_Key := NULL;
            IF p_stdush3.v_sttm_detail_sus3(l_index).MANDATORY_VALIDATION IS NOT NULL THEN
               IF p_stdush3.v_sttm_detail_sus3(l_index).MANDATORY_VALIDATION NOT IN ('Optional','Required') THEN
                  dbg('Invalid Value For The Field  :MANDATORY_VALIDATION:'||p_stdush3.v_sttm_detail_sus3(l_index).MANDATORY_VALIDATION);
                  l_key := Cspks_Req_Utils.Fn_Get_Item_Desc(p_source,g_ui_name,'STTM_DETAIL_SUS3.TEMP')||'-'||
                  p_stdush3.v_sttm_detail_sus3(l_index).temp;
                  Pr_Log_Error(p_Source,'ST-VALS-013',p_stdush3.v_sttm_detail_sus3(l_index).MANDATORY_VALIDATION||'~@STTM_DETAIL_SUS3.MANDATORY_VALIDATION'||'~'||l_Key||'~@STTM_DETAIL_SUS3') ;
               END IF;
            END IF;
         END LOOP;
      END IF;
      Dbg('Duplicate Records Check For :v_sttm_detail_sus3..');
      l_Count      := p_stdush3.v_sttm_detail_sus3.COUNT;
      IF l_Count > 0 THEN
         FOR l_index  IN 1 .. l_count LOOP
            l_key := NULL;
            IF l_index < l_Count THEN
               FOR l_index1 IN l_index+1 .. l_Count LOOP
                  IF (NVL(p_stdush3.v_sttm_detail_sus3(l_index).cust_id_det,'@')=  NVL(p_stdush3.v_sttm_detail_sus3(l_index1).cust_id_det,'@')) AND (NVL(p_stdush3.v_sttm_detail_sus3(l_index).temp,'@')=  NVL(p_stdush3.v_sttm_detail_sus3(l_index1).temp,'@')) THEN
                     Dbg('Duplicare Record Found for :'||l_Key);
                     l_key := Cspks_Req_Utils.Fn_Get_Item_Desc(p_source,g_ui_name,'STTM_DETAIL_SUS3.CUST_ID_DET')||'-'||
                     p_stdush3.v_sttm_detail_sus3(l_index).cust_id_det||':'||
                     Cspks_Req_Utils.Fn_Get_Item_Desc(p_source,g_ui_name,'STTM_DETAIL_SUS3.TEMP')||'-'||
                     p_stdush3.v_sttm_detail_sus3(l_index).temp;
                     Pr_Log_Error(p_Source,'ST-VALS-009','@STTM_DETAIL_SUS3~'||l_Key);
                  END IF;
               END LOOP;
            END IF;
         END LOOP;
   ...
   RETURN BOOLEAN   IS
      ...
      N_v_sttm_detail_sus3       stpks_stdush3_Main.Ty_Tb_v_sttm_detail_sus3;
   ...
   BEGIN
      ...
      l_fld := 'STTM_MASTER_SUS3.CUST_CAT';
      IF Fn_Amendable('STTM_MASTER_SUS3.CUST_CAT') THEN
         p_Wrk_stdush3.v_sttm_master_sus3.cust_cat := p_stdush3.v_sttm_master_sus3.cust_cat;
      ELSE
         IF p_stdush3.v_sttm_master_sus3.cust_cat IS NOT NULL THEN
            IF NVL(p_Wrk_stdush3.v_sttm_master_sus3.cust_cat,'@') <>
               NVL(p_stdush3.v_sttm_master_sus3.cust_cat,'@')  THEN
      ...
      END IF;
      l_fld := 'STTM_MASTER_SUS3.CUST_TYPE';
      IF Fn_Amendable('STTM_MASTER_SUS3.CUST_TYPE') THEN
         p_Wrk_stdush3.v_sttm_master_sus3.cust_type := p_stdush3.v_sttm_master_sus3.cust_type;
      ELSE
         IF p_stdush3.v_sttm_master_sus3.cust_type IS NOT NULL THEN
            IF NVL(p_Wrk_stdush3.v_sttm_master_sus3.cust_type,'@') <>
               NVL(p_stdush3.v_sttm_master_sus3.cust_type,'@')  THEN
               l_Modified_Flds := l_Modified_Flds ||'~'||l_Fld;
               l_Rec_Modified := TRUE;
            END IF;
         END IF;
      ...
      l_Blk := 'STTM_DETAIL_SUS3';
      l_Count      := p_stdush3.v_sttm_detail_sus3.COUNT;
      l_Wrk_Count  := p_Wrk_stdush3.v_sttm_detail_sus3.COUNT;
      IF l_Count > 0 THEN
         FOR l_index IN 1..l_Count  LOOP
            l_Rec_Found := FALSE;
            l_Rec_Modified := FALSE;
            ...
            IF l_Wrk_Count > 0 THEN
               FOR l_index1 IN 1..l_Wrk_Count  LOOP
                  IF (NVL(p_stdush3.v_sttm_detail_sus3(l_index).temp,'@')=  NVL(p_Wrk_stdush3.v_sttm_detail_sus3(l_index1).temp,'@')) THEN
                     Dbg('Record Found..');
                     l_Rec_Found := TRUE;
                     l_fld := 'STTM_DETAIL_SUS3.FIELD_DES';
                     IF Fn_Amendable('STTM_DETAIL_SUS3.FIELD_DES') THEN
                        p_Wrk_stdush3.v_sttm_detail_sus3(l_index1).field_des := p_stdush3.v_sttm_detail_sus3(l_index).field_des;
                     ELSE
                        IF p_stdush3.v_sttm_detail_sus3(l_index).field_des IS NOT NULL THEN
                           IF NVL(p_Wrk_stdush3.v_sttm_detail_sus3(l_index1).field_des,'@') <>
                              NVL(p_stdush3.v_sttm_detail_sus3(l_index).field_des,'@')  THEN
                              l_Modified_flds := l_Modified_Flds ||'~'||l_Fld;
                              l_Rec_Modified  := TRUE;
                           END IF;
                        END IF;
                     END IF;
                     l_fld := 'STTM_DETAIL_SUS3.MANDATORY_VALIDATION';
                     IF Fn_Amendable('STTM_DETAIL_SUS3.MANDATORY_VALIDATION') THEN
                        p_Wrk_stdush3.v_sttm_detail_sus3(l_index1).mandatory_validation := p_stdush3.v_sttm_detail_sus3(l_index).mandatory_validation;
                     ELSE
                        IF p_stdush3.v_sttm_detail_sus3(l_index).mandatory_validation IS NOT NULL THEN
                           IF NVL(p_Wrk_stdush3.v_sttm_detail_sus3(l_index1).mandatory_validation,'@') <>
                              NVL(p_stdush3.v_sttm_detail_sus3(l_index).mandatory_validation,'@')  THEN
                              l_Modified_flds := l_Modified_Flds ||'~'||l_Fld;
                              l_Rec_Modified  := TRUE;
                           END IF;
                        END IF;
            ...
            IF NOT l_Rec_Found THEN
               p_Wrk_stdush3.v_sttm_detail_sus3(p_Wrk_stdush3.v_sttm_detail_sus3.COUNT +1 ) :=  p_stdush3.v_sttm_detail_sus3(l_index);
               IF l_Amendable_Nodes.EXISTS('STTM_DETAIL_SUS3') THEN
                  IF l_Amendable_Nodes('STTM_DETAIL_SUS3').New_Allowed = 'N' THEN
      ...
      IF l_Amendable_Nodes.EXISTS('STTM_DETAIL_SUS3') THEN
         IF l_Amendable_Nodes('STTM_DETAIL_SUS3').All_Records = 'Y' THEN
            ...
            IF l_Wrk_Count > 0 THEN
               FOR l_index1 IN 1..l_Wrk_count  LOOP
                  ...
                  IF l_Count > 0 THEN
                     FOR l_index IN 1..l_Count  LOOP
                        IF (NVL(p_Wrk_stdush3.v_sttm_detail_sus3(l_index1).temp,'@')=  NVL(p_stdush3.v_sttm_detail_sus3  (l_index).temp,'@')) THEN
                           Dbg('Record Found..');
                           l_Rec_Found := TRUE;
                           EXIT;
                        END IF;
                  ...
                  IF l_Rec_Found THEN
                     Dbg('Adding  a Record...');
                     N_v_sttm_detail_sus3(N_v_sttm_detail_sus3.COUNT +1 ) :=  p_Wrk_stdush3.v_sttm_detail_sus3(l_Index1);
                  ELSE
                     l_Deleted_Recs := l_Deleted_Recs +1;
                     IF l_Amendable_Nodes.EXISTS('STTM_DETAIL_SUS3') THEN
                        IF l_Amendable_Nodes('STTM_DETAIL_SUS3').Delete_Allowed = 'N' THEN
                           Dbg('Record Cannot Be Deleted..');
                           l_key := Cspks_Req_Utils.Fn_Get_Item_Desc(p_source,g_ui_name,'STTM_DETAIL_SUS3.TEMP')||'-'||
                           p_Wrk_stdush3.v_sttm_detail_sus3(l_index1).temp;
               ...
               END LOOP;
            END IF;
            p_Wrk_stdush3.v_sttm_detail_sus3:= N_v_sttm_detail_sus3;
         END IF;
      END IF;
   ...
   FUNCTION Fn_Sys_Check_Mandatory_Nodes  (p_Source            IN VARCHAR2,
      p_Wrk_stdush3 IN  stpks_stdush3_Main.Ty_stdush3,
      p_Err_Code          IN OUT VARCHAR2,
      p_Err_Params        IN OUT VARCHAR2)
   RETURN BOOLEAN   IS
   ...
   BEGIN
      ...
      l_Blk := 'STTM_MASTER_SUS3';
      l_Fld := 'STTM_MASTER_SUS3.CUST_CAT';
      IF p_wrk_stdush3.v_sttm_master_sus3.CUST_CAT IS NOT NULL THEN
         SELECT COUNT(*) INTO l_LOV_COUNT  FROM  (SELECT CAT,DECSS FROM LOV_LL1) WHERE CAT = P_wrk_stdush3.v_sttm_master_sus3.CUST_CAT;
         IF l_lov_count = 0  THEN
            Dbg('Invalid Value For The Field  :CUST_CAT:'||p_Wrk_stdush3.v_sttm_master_sus3.CUST_CAT);
            Pr_Log_Error(p_Source,'ST-VALS-011',p_Wrk_stdush3.v_sttm_master_sus3.CUST_CAT||'~@STTM_MASTER_SUS3.CUST_CAT~@STTM_MASTER_SUS3') ;
         END IF;
      END IF;
   ...
   BEGIN
      ...
      IF p_Source <> 'FLEXCUBE'  THEN
         ...
         END;
      END IF;
      l_key := Cspks_Req_Utils.Fn_Get_Item_Desc(p_source,g_ui_name,'STTM_MASTER_SUS3.CUST_ID')||'-'||
      p_stdush3.v_sttm_master_sus3.cust_id;
      l_Prev_Key_Tags := 'CUST_ID~';
      l_Prev_Key_Vals := p_prev_stdush3.v_sttm_master_sus3.cust_id||'~';
      Dbg('Calling Cspks_Req_Utils.Fn_Maint_Basic_Validations..');
      IF NOT Cspks_Req_Utils.Fn_Maint_Basic_Validations (p_source,
         p_Source_Operation,
         p_Function_Id,
         p_Action_Code,
         p_Prev_stdush3.v_sttm_master_sus3.Mod_No,
         p_stdush3.v_sttm_master_sus3.Mod_No,
         p_Prev_stdush3.v_sttm_master_sus3.Auth_Stat,
         p_Prev_stdush3.v_sttm_master_sus3.Record_Stat,
         p_Prev_stdush3.v_sttm_master_sus3.Once_Auth,
         l_Prev_Key_Tags,
         l_Prev_Key_Vals,
         g_Key_Id,
         l_Key,
      ...
      IF ( p_Action_Code IN (Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen,Cspks_Req_Global.p_Delete,Cspks_Req_Global.p_Version_Delete,Cspks_Req_Global.p_Query) OR
            ( p_Action_Code = Cspks_Req_Global.p_Modify AND NVL(p_Prev_stdush3.v_sttm_master_sus3.Once_Auth,'N') = 'Y')) THEN
         p_Wrk_stdush3 := p_Prev_stdush3;
         p_wrk_stdush3.v_sttm_master_sus3.Mod_No := p_stdush3.v_sttm_master_sus3.Mod_No;
         p_Wrk_stdush3.Addl_Info := p_stdush3.Addl_Info ;
      ELSE
         p_Wrk_stdush3 := p_stdush3;
      END IF;
      IF p_Action_Code = Cspks_Req_Global.p_Auth THEN
         IF p_Wrk_stdush3.v_sttm_master_sus3.Mod_No IS NULL THEN
            p_Wrk_stdush3.v_sttm_master_sus3.Mod_No           := p_prev_stdush3.v_sttm_master_sus3.Mod_No;
         END IF;
         p_Wrk_stdush3.v_sttm_master_sus3.Checker_dt_stamp   := fn_mntstamp;
         p_Wrk_stdush3.v_sttm_master_sus3.Checker_id         := Global.user_id;
      ELSIF p_Action_Code IN (Cspks_Req_Global.p_New,Cspks_Req_Global.p_Modify,Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen) THEN
         p_Wrk_stdush3.v_sttm_master_sus3.Auth_Stat        := 'U';
         IF NOT Cspks_Req_Global.Fn_UnTanking THEN
            p_Wrk_stdush3.v_sttm_master_sus3.Maker_Id         := Global.User_Id;
            p_Wrk_stdush3.v_sttm_master_sus3.Maker_Dt_Stamp   := Fn_Mntstamp;
         ELSE
            p_Wrk_stdush3.v_sttm_master_sus3.Maker_Id         := NVL(p_stdush3.v_sttm_master_sus3.Maker_Id,Global.User_Id);
            p_Wrk_stdush3.v_sttm_master_sus3.Maker_Dt_Stamp   := NVL(p_stdush3.v_sttm_master_sus3.Maker_Dt_Stamp,Fn_Mntstamp);
         END IF;

         IF p_Action_Code = Cspks_Req_Global.p_New THEN
            IF NOT Cspks_Req_Global.Fn_UnTanking THEN
               p_Wrk_stdush3.v_sttm_master_sus3.Mod_No           := 1;
            ELSE
               p_Wrk_stdush3.v_sttm_master_sus3.Mod_No := NVL(p_Wrk_stdush3.v_sttm_master_sus3.Mod_No,1);
            END IF;
            p_Wrk_stdush3.v_sttm_master_sus3.Record_Stat      := 'O';
            p_Wrk_stdush3.v_sttm_master_sus3.Once_Auth        := 'N';
         ELSE
            IF NOT Cspks_Req_Global.Fn_UnTanking THEN
               p_wrk_stdush3.v_sttm_master_sus3.Mod_No           := NVL(p_prev_stdush3.v_sttm_master_sus3.Mod_No,0)+1;
            ELSE
               p_Wrk_stdush3.v_sttm_master_sus3.Mod_No           := NVL(p_stdush3.v_sttm_master_sus3.Mod_No,1);
            END IF;
            p_Wrk_stdush3.v_sttm_master_sus3.Once_Auth           := NVL(p_Prev_stdush3.v_sttm_master_sus3.Once_Auth,'N');
            p_wrk_stdush3.v_sttm_master_sus3.Record_Stat           := NVL(p_prev_stdush3.v_sttm_master_sus3.Record_Stat,'O');
         END IF;
         IF p_Action_Code = Cspks_Req_Global.p_Close THEN
            p_Wrk_stdush3.v_sttm_master_sus3.Record_Stat      := 'C';
         ELSIF p_Action_Code = Cspks_Req_Global.p_Reopen THEN
            p_Wrk_stdush3.v_sttm_master_sus3.Record_Stat      := 'O';
         END IF;
         p_Wrk_stdush3.v_sttm_master_sus3.Checker_id         := Null;
         p_Wrk_stdush3.v_sttm_master_sus3.Checker_Dt_Stamp         := Null;
      ...
      IF p_Action_Code in  (Cspks_Req_Global.p_New,Cspks_Req_Global.p_Modify) THEN
         ...
         IF p_Action_Code = Cspks_Req_Global.p_New OR  ( p_Action_Code = Cspks_Req_Global.p_Modify AND p_Prev_stdush3.v_sttm_master_sus3.Once_Auth = 'N') THEN
         ...
         END IF;
         IF p_Action_Code = Cspks_Req_Global.p_Modify AND p_Prev_stdush3.v_sttm_master_sus3.Once_Auth = 'Y'THEN
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdush3_Main.Fn_Sys_Default_And_Validate ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   RETURN BOOLEAN IS
      ...
      l_Dsn_Rec_Cnt_2 NUMBER := 0;
      l_Bnd_Cntr_2    NUMBER := 0;
      Cursor c_v_sttm_detail_sus3 IS
      SELECT *
   ...
   BEGIN
      ...
      ELSE
         ...
         IF NVL(p_With_Lock,'N') = 'Y' THEN
            BEGIN
               SELECT *
               INTO   p_wrk_stdush3.v_sttm_master_sus3
               FROM  STTM_MASTER_SUS3
               WHERE cust_id = p_stdush3.v_sttm_master_sus3.cust_id
                FOR UPDATE NOWAIT;
            EXCEPTION
         ...
         IF p_Full_Data = 'Y' AND l_Rec_Exists THEN
            Dbg('Get the Record For :STTM_MASTER_SUS3');
            BEGIN
               SELECT *
               INTO p_Wrk_stdush3.v_sttm_master_sus3
               FROM   STTM_MASTER_SUS3
               WHERE cust_id = p_wrk_stdush3.v_sttm_master_sus3.cust_id
               ;
            EXCEPTION
               WHEN OTHERS THEN
                  Dbg(SQLERRM);
                  Dbg('Failed in Selecting The Record For :STTM_MASTER_SUS3');
            END;
            Dbg('Get the Record For :STTM_DETAIL_SUS3');
            OPEN c_v_sttm_detail_sus3;
            LOOP
               FETCH c_v_sttm_detail_sus3
               BULK COLLECT INTO p_Wrk_stdush3.v_sttm_detail_sus3;
                EXIT WHEN c_v_sttm_detail_sus3%NOTFOUND;
            END LOOP;
            CLOSE c_v_sttm_detail_sus3;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         ...
         Debug.Pr_Debug('**',SQLERRM);
         IF  c_v_sttm_detail_sus3%ISOPEN THEN
            CLOSE c_v_sttm_detail_sus3;
         END IF;
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
   ...
   RETURN BOOLEAN   IS
      ...
      l_Base_Data_From_Fc VARCHAR2(1):= 'Y';
      I_v_sttm_detail_sus3       stpks_stdush3_Main.Ty_Tb_v_sttm_detail_sus3;
      U_v_sttm_detail_sus3       stpks_stdush3_Main.Ty_Tb_v_sttm_detail_sus3;
      D_v_sttm_detail_sus3       stpks_stdush3_Main.Ty_Tb_v_sttm_detail_sus3;
   BEGIN
      Dbg('In Fn_Sys_Upload_Db..');
      IF p_Action_Code = Cspks_Req_Global.p_new THEN

         Dbg('Inserting Into STTM_MASTER_SUS3..');
         BEGIN
            IF  p_wrk_stdush3.v_sttm_master_sus3.cust_id IS NOT NULL THEN
               Dbg('Record Sent..');
               INSERT INTO  STTM_MASTER_SUS3
               VALUES p_wrk_stdush3.v_sttm_master_sus3;
            END IF;
         EXCEPTION
            WHEN OTHERS THEN
               Dbg('Failed In Insert intoSTTM_MASTER_SUS3..');
               Dbg(SQLERRM);
               p_Err_Code    := 'ST-UPLD-001';
               p_Err_Params  := '@STTM_MASTER_SUS3';
               RETURN FALSE;
         END;

         Dbg('Inserting Into STTM_DETAIL_SUS3..');
         BEGIN
            l_Count      := p_wrk_stdush3.v_sttm_detail_sus3.COUNT;
            FORALL l_index IN  1..l_count
            INSERT INTO STTM_DETAIL_SUS3
            VALUES p_wrk_stdush3.v_sttm_detail_sus3(l_index);
         EXCEPTION
            WHEN OTHERS THEN
               Dbg('Failed In Insert intoSTTM_DETAIL_SUS3..');
               Dbg(SQLERRM);
               p_Err_Code    := 'ST-UPLD-001';
               p_Err_Params  := '@STTM_DETAIL_SUS3';
               RETURN FALSE;
         END;
      ELSIF p_Action_Code = Cspks_Req_Global.p_modify THEN

         Dbg('Updating Single Record Node :  STTM_MASTER_SUS3..');
         BEGIN
            UPDATE STTM_MASTER_SUS3
            SET
            CUST_CAT = p_Wrk_stdush3.v_sttm_master_sus3.CUST_CAT,
            CUST_TYPE = p_Wrk_stdush3.v_sttm_master_sus3.CUST_TYPE,
            MAKER_ID = p_Wrk_stdush3.v_sttm_master_sus3.MAKER_ID,
            MAKER_DT_STAMP = p_Wrk_stdush3.v_sttm_master_sus3.MAKER_DT_STAMP,
            CHECKER_ID = p_Wrk_stdush3.v_sttm_master_sus3.CHECKER_ID,
            CHECKER_DT_STAMP = p_Wrk_stdush3.v_sttm_master_sus3.CHECKER_DT_STAMP,
            MOD_NO = p_Wrk_stdush3.v_sttm_master_sus3.MOD_NO,
            RECORD_STAT = p_Wrk_stdush3.v_sttm_master_sus3.RECORD_STAT,
            AUTH_STAT = p_Wrk_stdush3.v_sttm_master_sus3.AUTH_STAT,
            ONCE_AUTH = p_Wrk_stdush3.v_sttm_master_sus3.ONCE_AUTH
WHERE cust_id = p_Wrk_stdush3.v_sttm_master_sus3.cust_id
;
         EXCEPTION
            WHEN OTHERS THEN
               Dbg('Failed in Insert Into STTM_MASTER_SUS3..');
               Dbg(SQLERRM);
               p_Err_Code    := 'ST-UPLD-001';
               p_Err_Params  := '@STTM_MASTER_SUS3';
               RETURN FALSE;
         ...
         Dbg('Preapring Insert and Update Types for  STTM_DETAIL_SUS3..');
         l_Wrk_Count  := p_Wrk_stdush3.v_sttm_detail_sus3.COUNT;
         l_Prev_Count := p_Prev_stdush3.v_sttm_detail_sus3.COUNT;
         IF l_Wrk_Count > 0 THEN
            FOR l_index IN 1 .. l_Wrk_Count LOOP
               l_Rec_Found    := FALSE;
               IF l_Prev_Count >  0 THEN
                  FOR l_index1 IN 1..l_Prev_Count  LOOP
                     IF (NVL(p_Wrk_stdush3.v_sttm_detail_sus3(l_index).temp,'@')=  NVL(p_Prev_stdush3.v_sttm_detail_sus3  (l_index1).temp,'@')) THEN
               ...
               IF l_rec_found THEN
                  ...
                  U_v_sttm_detail_sus3(U_v_sttm_detail_sus3.COUNT +1 ) :=  p_Wrk_stdush3.v_sttm_detail_sus3(l_index);
               ELSE
                  Dbg('Record is Added...');
                  I_v_sttm_detail_sus3(I_v_sttm_detail_sus3.COUNT +1 ) :=  p_Wrk_stdush3.v_sttm_detail_sus3(l_index);
               END IF;
            END LOOP;
         END IF;

         Dbg('Preapring Delete Types for  STTM_DETAIL_SUS3..');
         l_Wrk_Count  := p_wrk_stdush3.v_sttm_detail_sus3.COUNT;
         l_Prev_Count := p_prev_stdush3.v_sttm_detail_sus3.COUNT;
         IF l_Prev_Count > 0 THEN
            FOR l_index1 IN 1 .. l_Prev_Count LOOP
               ...
               IF NOT l_Rec_Found THEN
                  ...
                  D_v_sttm_detail_sus3(D_v_sttm_detail_sus3.COUNT +1 ) :=  p_Prev_stdush3.v_sttm_detail_sus3(l_index1);
               END IF;
            END LOOP;
         END IF;
         l_Del_Count  := D_v_sttm_detail_sus3.COUNT;
         Dbg('Records Deleted  :'||l_Del_Count);
         IF l_Del_Count > 0 THEN
            FOR l_index IN 1 .. l_del_count LOOP
               Dbg('Deleting Record...');
               DELETE STTM_DETAIL_SUS3
               WHERE cust_id_det = D_v_sttm_detail_sus3(l_index).cust_id_det
                AND temp = D_v_sttm_detail_sus3(l_index).temp
               ;
            END LOOP;
         END IF;
         l_Ins_Count  := I_v_sttm_detail_sus3.COUNT;
         Dbg('New Records Added  :'||l_ins_count);
         BEGIN
            l_Count      := I_v_sttm_detail_sus3.COUNT;
            FORALL l_Index IN  1..l_count
            INSERT INTO STTM_DETAIL_SUS3
            VALUES I_v_sttm_detail_sus3(l_index);
         EXCEPTION
            WHEN OTHERS THEN
               Dbg('Failed in Insert IntoSTTM_DETAIL_SUS3..');
               Dbg(SQLERRM);
               ...
               RETURN FALSE;
         END;
         l_Upd_Count  := U_v_sttm_detail_sus3.COUNT;
         Dbg('Records Modified  :'||l_Upd_Count);
         IF l_Upd_Count > 0 THEN
            FOR l_index IN 1 .. l_Upd_Count LOOP
               Dbg('Updating The  Record...');
               BEGIN
                  UPDATE STTM_DETAIL_SUS3
                  SET
                  FIELD_DES = U_v_sttm_detail_sus3(l_index).FIELD_DES,
                  MANDATORY_VALIDATION = U_v_sttm_detail_sus3(l_index).MANDATORY_VALIDATION
WHERE cust_id_det = U_v_sttm_detail_sus3(l_index).cust_id_det
 AND temp = U_v_sttm_detail_sus3(l_index).temp
;
               EXCEPTION
                  WHEN OTHERS THEN
                     Dbg('Failed in Updating STTM_DETAIL_SUS3..');
                     Dbg(SQLERRM);
                     p_Err_Code    := 'ST-UPLD-001';
                     p_Err_Params  := '@STTM_DETAIL_SUS3';
                     RETURN FALSE;
      ...
      ELSIF p_Action_Code = Cspks_Req_Global.p_delete THEN
         ...
         DELETE STTM_MASTER_SUS3 WHERE cust_id = p_Wrk_stdush3.v_sttm_master_sus3.cust_id
         ;


      ELSIF p_Action_Code IN (Cspks_Req_Global.p_Auth,Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen ) THEN
         l_key := Cspks_Req_Utils.Fn_Get_Item_Desc(p_source,g_ui_name,'STTM_MASTER_SUS3.CUST_ID')||'-'||
         p_Wrk_stdush3.v_sttm_master_sus3.cust_id;
         BEGIN
            SELECT ROWID
            INTO   l_row_id
            FROM  STTM_MASTER_SUS3
         ...
         IF NOT Cspks_Req_Utils.Fn_Maint_Operations(p_Source,
            ...
            'STTM_MASTER_SUS3',
            l_Row_Id,
            p_Wrk_stdush3.v_sttm_master_sus3.mod_no,
            p_Wrk_stdush3.v_sttm_master_sus3.Maker_dt_Stamp,
            p_Wrk_stdush3.v_sttm_master_sus3.Checker_dt_Stamp,
            g_Key_Id,
            l_Key,
            p_Err_Code,
            p_Err_params) THEN
   ...
   BEGIN
      ...
      IF NOT stpks_stdush3_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdush3_Custom.Fn_Post_Build_Type_Structure(p_Source,
            p_Source_Operation,
            p_Function_Id,
            p_Action_Code,
            l_Child_Function,
            ...
            p_Err_Code,
            p_Err_Params)  THEN
            Dbg('Failed in stpks_stdush3_Custom.Fn_Post_Build_Type_Structure..');
            RETURN FALSE;
         END IF;
      END IF;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdush3_Main.Fn_Build_Type ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         debug.pr_debug('**','In when others of stpks_stdush3_Main.Fn_Build_Ts_List ..');
         debug.pr_debug('**',SQLERRM);
         p_err_code    := 'ST-OTHR-001';
         p_err_params  := NULL;
         RETURN FALSE;
   ...
   BEGIN
      ...
      IF NOT Cspks_Req_Utils.Fn_Get_Key_Information(p_Source,
         ...
         RETURN FALSE;
      END IF;
      IF p_stdush3.Addl_Info.EXISTS('RECORD_KEY') THEN
         G_Req_Key :=  p_stdush3.Addl_Info('RECORD_KEY');
      END IF;
      IF p_stdush3.Addl_Info.EXISTS('KEY_ID') THEN
         G_Key_Id :=  p_stdush3.Addl_Info('KEY_ID');
      END IF;
      p_stdush3.Addl_Info('SENT_MOD_NO') :=p_stdush3.v_sttm_master_sus3.Mod_No;
      Dbg('Returning Succsess From Fn_Get_Key_Information..');
      RETURN TRUE;

   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdush3_Main.Fn_Get_Key_Information..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   BEGIN
      ...
      IF NOT stpks_stdush3_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdush3_Custom.Fn_Pre_Check_Mandatory (p_Source,
            p_Source_Operation,
            p_Function_Id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params)  THEN
            Dbg('Failed in  stpks_stdush3_Custom.Fn_Pre_Check_Mandatory..');
            RETURN FALSE;
         END IF;
      END IF;

      IF NOT stpks_stdush3_Main.Fn_Skip_Sys THEN
      ...
      IF NOT stpks_stdush3_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdush3_Custom.Fn_Post_Check_Mandatory (p_Source,
            p_Source_Operation,
            p_Function_Id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params)  THEN
            Dbg('Failed in  stpks_stdush3_Custom.Fn_Post_Check_Mandatory..');
            RETURN FALSE;
         END IF;
      END IF;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdush3_Main.Fn_Check_Mandatory ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   BEGIN
      ...
      l_Mod_No := p_stdush3.v_sttm_master_sus3.Mod_No;
      ...
      IF l_Tanked_data_Found THEN
         IF l_Bld_Type_From_Tanked_Data THEN
            ...
            stpks_stdush3_Main.Pr_Set_Skip_custom;
            Pr_Skip_Handler('POSTTANKQRY');
            Dbg('Calling Post Query Hooks After Query Of Tanked Data');
            IF NOT stpks_stdush3_Main.Fn_Skip_custom  THEN
               IF NOT stpks_stdush3_Custom.Fn_Post_Query (p_Source,
                  p_Source_operation,
                  p_Function_id,
                  p_Action_Code,
                  p_Function_Id  ,
                  ...
                  p_Err_Code,
                  p_Err_Params) THEN
                  Dbg('Failed in stpks_stdush3_Custom.Fn_Post_Query of Tanked Data');
                  RETURN FALSE;
               END IF;
            END IF;
      ...
      ELSE
         ...
         IF NOT stpks_stdush3_Main.Fn_Skip_custom  THEN
            IF NOT stpks_stdush3_Custom.Fn_Pre_Query (p_Source,
               p_Source_Operation,
               p_Function_Id,
               p_Action_Code,
               p_function_Id  ,
               ...
               p_Err_Code  ,
               p_Err_Params ) THEN
               Dbg('Failed in stpks_stdush3_Custom.Fn_Pre_Query..');
               RETURN FALSE;
            END IF;
         END IF;
         IF NOT stpks_stdush3_Main.Fn_Skip_Sys THEN
         ...
         IF NOT stpks_stdush3_Main.Fn_Skip_custom  THEN
            IF NOT stpks_stdush3_Custom.Fn_Post_Query (p_Source,
               ...
               p_Err_Code  ,
               p_Err_Params ) THEN
               Dbg('Failed in stpks_stdush3_Custom.Fn_Post_Query..');
               RETURN FALSE;
            END IF;
         END IF;
      END IF;
   ...
   BEGIN
      ...
      IF NOT stpks_stdush3_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdush3_Custom.Fn_Pre_Default_And_Validate (p_Source,
            p_Source_Operation,
            p_Function_Id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params) THEN
            Dbg('Failed in stpks_stdush3_Custom.Fn_Pre_Default_And_Validate..');
            RETURN FALSE;
         END IF;
      END IF;
      IF NOT stpks_stdush3_Main.Fn_Skip_Sys THEN
      ...
      IF NOT stpks_stdush3_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdush3_Custom.Fn_Post_Default_And_Validate (p_Source,
            p_Source_Operation,
            p_Function_Id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params) THEN
            Dbg('Failed in stpks_stdush3_Custom.Fn_Post_Default_And_Validate..');
            RETURN FALSE;
         END IF;
      END IF;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdush3_Main.Fn_Default_And_Validate ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   BEGIN
      ...
      IF NOT stpks_stdush3_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdush3_Custom.Fn_Pre_Upload_Db (p_Source,
            p_Source_operation,
            p_Function_id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params) THEN
            Dbg('Failed in stpks_stdush3_Custom.Fn_Pre_Upload_Db..');
            RETURN FALSE;
         END IF;
      END IF;
      IF NOT stpks_stdush3_Main.Fn_Skip_Sys THEN
      ...
      IF NOT stpks_stdush3_Main.Fn_Skip_custom  THEN
         IF NOT stpks_stdush3_Custom.Fn_Post_Upload_Db (p_Source,
            p_Source_operation,
            p_Function_id,
            p_Action_Code,
            p_function_Id  ,
            ...
            p_Err_Code,
            p_Err_Params) THEN
            Dbg('Failed in stpks_stdush3_Custom.Fn_Post_Upload_Db..');
            RETURN FALSE;
         END IF;
      END IF;
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others of stpks_stdush3_Main.Fn_Upload_Db ..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   RETURN BOOLEAN IS
      ...
      l_Summary_Rec     STTM_MASTER_SUS3%ROWTYPE;
   ...
   BEGIN
      ...
      IF  p_Action_Code IN (Cspks_Req_Global.p_New,Cspks_Req_Global.p_Modify,Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen) THEN
         ...
         IF g_Key_Id IS NOT NULL THEN
            l_Summary_Rec := p_stdush3.v_sttm_master_sus3;
            IF l_Summary_Rec_Found THEN
               ...
               p_Record_Master.CHAR_FLD_1 := l_Summary_Rec.CUST_CAT;
               p_Record_Master.CHAR_FLD_2 := l_Summary_Rec.CUST_ID;
               p_Record_Master.CHAR_FLD_3 := l_Summary_Rec.CUST_TYPE;
            END IF;
         END IF;
      END IF;
   ...
   RETURN BOOLEAN IS
      ...
      l_wrk_stdush3      stpks_stdush3_Main.Ty_stdush3;
      l_Skip_custom      BOOLEAN := FALSE;
      ...
      IF  p_Action_Code IN (Cspks_Req_Global.p_New,Cspks_Req_Global.p_Modify,Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen,Cspks_Req_Global.p_Auth,Cspks_Req_Global.p_Delete,Cspks_Req_Global.p_Version_Delete) THEN
         ...
         IF l_Key_Id IS NOT NULL THEN
            IF p_Action_Code IN( Cspks_Req_Global.p_auth,Cspks_Req_Global.p_Delete,Cspks_Req_Global.p_Version_Delete) THEN
               IF p_stdush3.v_sttm_master_sus3.Mod_no IS NOT NULL THEN
                  l_Mod_No           := p_stdush3.v_sttm_master_sus3.Mod_No;
               ELSE
                  l_Mod_No           := p_Wrk_stdush3.v_sttm_master_sus3.Mod_No;
               END IF;
            ELSE
               l_mod_no           := p_wrk_stdush3.v_sttm_master_sus3.mod_no;
            END IF;
              l_Auth_Stat := NVL(p_Wrk_stdush3.v_sttm_master_sus3.Auth_Stat,'U') ;
            ...
            IF Cspks_Req_Utils.Fn_Field_Log_Reqd(p_Function_Id,p_Action_Code) THEN
               ...
               IF p_Prev_stdush3.v_sttm_master_sus3.cust_id IS NOT NULL THEN
               ...
               IF l_Prev_Found   THEN
                  l_Dtl_key := '~STTM_MASTER_SUS3~'||p_Prev_stdush3.v_sttm_master_sus3.cust_id||'~';
               ELSIF l_Wrk_Found   THEN
                  l_Dtl_key := '~STTM_MASTER_SUS3~'||p_Wrk_stdush3.v_sttm_master_sus3.cust_id||'~';
               END IF;
               IF l_Wrk_Found  OR l_Prev_Found THEN
                  ...
                  ELSIF (NOT l_wrk_Found)  AND l_Prev_Found THEN
                     l_Rec_Action := 'D';
                  END IF;
                  Pr_Log_Change('CUST_CAT',l_Rec_Action,p_Prev_stdush3.v_sttm_master_sus3.cust_cat,p_Wrk_stdush3.v_sttm_master_sus3.cust_cat);
Pr_Log_Change('CUST_ID',l_Rec_Action,p_Prev_stdush3.v_sttm_master_sus3.cust_id,p_Wrk_stdush3.v_sttm_master_sus3.cust_id);
Pr_Log_Change('CUST_TYPE',l_Rec_Action,p_Prev_stdush3.v_sttm_master_sus3.cust_type,p_Wrk_stdush3.v_sttm_master_sus3.cust_type);
Pr_Log_Change('MAKER_ID',l_Rec_Action,p_Prev_stdush3.v_sttm_master_sus3.maker_id,p_Wrk_stdush3.v_sttm_master_sus3.maker_id);
Pr_Log_Change('MAKER_DT_STAMP',l_Rec_Action,p_Prev_stdush3.v_sttm_master_sus3.maker_dt_stamp,p_Wrk_stdush3.v_sttm_master_sus3.maker_dt_stamp);
Pr_Log_Change('CHECKER_ID',l_Rec_Action,p_Prev_stdush3.v_sttm_master_sus3.checker_id,p_Wrk_stdush3.v_sttm_master_sus3.checker_id);
Pr_Log_Change('CHECKER_DT_STAMP',l_Rec_Action,p_Prev_stdush3.v_sttm_master_sus3.checker_dt_stamp,p_Wrk_stdush3.v_sttm_master_sus3.checker_dt_stamp);
Pr_Log_Change('MOD_NO',l_Rec_Action,p_Prev_stdush3.v_sttm_master_sus3.mod_no,p_Wrk_stdush3.v_sttm_master_sus3.mod_no);
Pr_Log_Change('RECORD_STAT',l_Rec_Action,p_Prev_stdush3.v_sttm_master_sus3.record_stat,p_Wrk_stdush3.v_sttm_master_sus3.record_stat);
Pr_Log_Change('AUTH_STAT',l_Rec_Action,p_Prev_stdush3.v_sttm_master_sus3.auth_stat,p_Wrk_stdush3.v_sttm_master_sus3.auth_stat);
Pr_Log_Change('ONCE_AUTH',l_Rec_Action,p_Prev_stdush3.v_sttm_master_sus3.once_auth,p_Wrk_stdush3.v_sttm_master_sus3.once_auth);


                              END IF;


               l_Dbt := 'STTM_DETAIL_SUS3';
               l_Blk := 'STTM_DETAIL_SUS3';
               l_Wrk_Count  := p_Wrk_stdush3.v_sttm_detail_sus3.COUNT;
               l_Prev_Count      := p_Prev_stdush3.v_sttm_detail_sus3.COUNT;
               IF l_Wrk_count > 0 THEN
                  FOR l_Index IN 1..l_Wrk_count  LOOP
                     l_Dtl_key := '~STTM_DETAIL_SUS3~'||p_wrk_stdush3.v_sttm_detail_sus3(l_index).cust_id_det||'~'||p_wrk_stdush3.v_sttm_detail_sus3(l_index).temp||'~';
                     l_Rec_Found := FALSE;
                     l_Rec_Modified := FALSE;
                     IF l_Prev_count > 0 THEN
                        FOR l_Index1 IN 1..l_Prev_count  LOOP
                           IF (NVL(p_Wrk_stdush3.v_sttm_detail_sus3(l_Index).temp,'@')=  NVL(p_Prev_stdush3.v_sttm_detail_sus3(l_Index1).temp,'@')) THEN
                              ...
                              Pr_Log_Change('FIELD_DES','M',p_Prev_stdush3.v_sttm_detail_sus3(l_Index1).field_des,p_Wrk_stdush3.v_sttm_detail_sus3(l_Index).field_des);
Pr_Log_Change('MANDATORY_VALIDATION','M',p_Prev_stdush3.v_sttm_detail_sus3(l_Index1).mandatory_validation,p_Wrk_stdush3.v_sttm_detail_sus3(l_Index).mandatory_validation);
Pr_Log_Change('TEMP','M',p_Prev_stdush3.v_sttm_detail_sus3(l_Index1).temp,p_Wrk_stdush3.v_sttm_detail_sus3(l_Index).temp);
                     ...
                     IF NOT l_rec_found THEN
                        ...
                        Pr_Log_Change('FIELD_DES','N',NULL,p_wrk_stdush3.v_sttm_detail_sus3(l_Index).field_des);
Pr_Log_Change('MANDATORY_VALIDATION','N',NULL,p_wrk_stdush3.v_sttm_detail_sus3(l_Index).mandatory_validation);
Pr_Log_Change('TEMP','N',NULL,p_wrk_stdush3.v_sttm_detail_sus3(l_Index).temp);
               ...
               IF l_Prev_Count > 0 THEN
                  FOR l_Index IN 1..l_Prev_count  LOOP
                     ...
                     IF l_Wrk_Count > 0 THEN
                        FOR l_Index1 IN 1..l_Wrk_Count  LOOP
                           IF (NVL(p_Prev_stdush3.v_sttm_detail_sus3(l_Index).temp,'@')=  NVL(p_Wrk_stdush3.v_sttm_detail_sus3(l_Index1).temp,'@')) THEN
                              Dbg('Record Found..');
                              l_Rec_Found := TRUE;
                              EXIT;
                     ...
                     IF NOT l_Rec_Found THEN
                        Dbg('Record Deleted..');
                        l_Dtl_key := '~STTM_DETAIL_SUS3~'||p_Prev_stdush3.v_sttm_detail_sus3(l_Index).cust_id_det||'~'||p_Prev_stdush3.v_sttm_detail_sus3(l_Index).temp||'~';
                        Pr_Log_Change('FIELD_DES','D',p_Prev_stdush3.v_sttm_detail_sus3(l_Index).field_des,NULL);
Pr_Log_Change('MANDATORY_VALIDATION','D',p_Prev_stdush3.v_sttm_detail_sus3(l_Index).mandatory_validation,NULL);
Pr_Log_Change('TEMP','D',p_Prev_stdush3.v_sttm_detail_sus3(l_Index).temp,NULL);
            ...
            IF NOT stpks_stdush3_Main.Fn_Skip_custom  THEN
               IF NOT stpks_stdush3_Custom.Fn_Post_Upload_Db (p_Source,
                  ...
                  p_Err_Code,
                  p_Err_Params) THEN
                  Dbg('Failed in stpks_stdush3_Custom.Fn_Post_Upload_Db After Logging');
                  RETURN FALSE;
               END IF;
            END IF;
            g_Skip_custom:= l_Skip_custom;
   ...
   RETURN BOOLEAN IS
      ...
      l_stdush3     stpks_stdush3_Main.Ty_stdush3;
   ...
   BEGIN
      ...
      IF NOT  Fn_Get_Key_Information(p_Source,
         ...
         RAISE e_Failure_Exception;
      END IF;
      p_Addl_Info := l_stdush3.Addl_Info;
   ...
   BEGIN
      ...
      p_Node_Data(l_Cntr).Query_Node := '0';
      p_Node_Data(l_Cntr).Node_Fields := 'CUST_ID_DET~FIELD_DES~MANDATORY_VALIDATION~TEMP~';
      p_Node_Data(l_Cntr).Node_Tags := 'CUST_ID_DET~FIELD_DES~MANDATORY_VALIDATION~TEMP~';
   ...
   EXCEPTION
      WHEN OTHERS THEN
         Debug.Pr_Debug('**','In When Others Of stpks_stdush3_Main.Fn_Get_Node_Data..');
         Debug.Pr_Debug('**',SQLERRM);
         p_Err_Code    := 'ST-OTHR-001';
         p_Err_Params  := NULL;
         RETURN FALSE;
   ...
   RETURN BOOLEAN IS
      ...
      l_Wrk_stdush3    stpks_stdush3_Main.Ty_stdush3;
      l_Prev_stdush3    stpks_stdush3_Main.Ty_stdush3;
      l_Dmy_stdush3    stpks_stdush3_Main.Ty_stdush3;
   ...
   BEGIN
      ...
      SAVEPOINT Sp_Int_Main_Stdush3;
      p_Status := 'S';
      g_Tanking_Status := l_Tanking_Status;
      g_stdush3 := p_stdush3;
      l_Wrk_stdush3 := p_stdush3;
      ...
      IF NOT  Fn_Get_Key_Information(p_Source,
         ...
         RAISE e_Failure_Exception;
      END IF;
      l_Sent_Mod_No := p_stdush3.v_sttm_master_sus3.Mod_No;
      ...
      ELSE
         ...
         IF l_Resultant_Error_Type <> 'E' THEN
            ...
            IF  l_Action_Code IN (Cspks_Req_Global.p_New,Cspks_Req_Global.p_Modify,Cspks_Req_Global.p_Close,Cspks_Req_Global.p_Reopen) THEN
               l_Prev_Auth_Stat := NVL(l_Prev_stdush3.v_sttm_master_sus3.Auth_Stat,'A') ;
               --Get Upload Status
      ...
      IF l_Action_Code = Cspks_Req_Global.p_Delete AND p_Source = 'FLEXCUBE'  THEN
         l_Wrk_stdush3 := l_Dmy_stdush3;
      END IF;
      p_stdush3 := l_wrk_stdush3;
      Dbg('Errors     :'||p_Err_Code);
      Dbg('Parameters :'||p_Err_Params);
   ...
   EXCEPTION
      WHEN E_Failure_Exception THEN
         ...
         ROLLBACK TO Sp_Int_Main_Stdush3;
         p_Status        := 'F';
         l_Post_Upl_Stat := 'F';
         Cspks_Req_Utils.Pr_Get_Final_Err_Code(p_Function_Id,l_Action_Code,l_Post_Upl_Stat,p_Err_Code,p_Err_Params);
         Pr_Log_Error(p_Source,p_Err_Code,p_Err_Params);
