CREATE OR REPLACE PACKAGE  stpks_stdush1_main AS
  /*-----------------------------------------------------------------------------------------------------
  **
  ** File Name  : stpks_stdush1_main.spc
  **
...
TYPE ty_stdush1 IS RECORD (
     v_stb_master_sush1     stb_master_sush1%ROWTYPE,
...
/
CREATE OR REPLACE SYNONYM stpkss_stdush1_main FOR stpks_stdush1_main
/